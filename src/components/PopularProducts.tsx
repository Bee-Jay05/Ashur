...
export default function PopularProducts() {
  return (
    <section className="py-12 w-[90vw] mx-auto">
      <h2 className="text-5xl font-normal mb-2 text-start mb-12 relative after:w-[250px] after:h-[4px] after:bg-cyan-500 after:content-[''] after:absolute after:-top-[4px] after:left-0 after:rounded-xs">Popular Products</h2>
